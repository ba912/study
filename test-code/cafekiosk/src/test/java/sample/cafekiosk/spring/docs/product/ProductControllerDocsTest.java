        ...
        mockMvc.perform(
                ...
                .andDo(document("product-create",
                        ...
                        requestFields(
                                ...
                                fieldWithPath("sellingStatus").type(JsonFieldType.STRING).optional().description("판매 상태"),
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data.sellingStatus").type(JsonFieldType.STRING).description("판매 상태"),
